...
const createTmpFile = sourceFile => {
  ...
  tmpSourceFile.insertText(tmpSourceFile.getEnd(), "import { assertType, CanAssign } from 'type-plus';");
...
function typeSet(sourceFile, types) {
  ...
  return _.uniqWith(types, (a, b) => isEqualType(a, b, 'returnType', 'returnType'));
}
